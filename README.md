...
* <s>Maybe i want to make a database to track all the times you set across all gamemodes with all cars? unfortunately the game does not export weather info.....<s>